...
class Complejo():
    ...
    def mult(self, d):
        c=Complejo(self.real, self.imaginario)
        self.real=(c.real*d.real)-(c.imaginario*d.imaginario)
        self.imaginario=(c.real*d.imaginario)+(c.imaginario*d.real)
       
    
#añadir metodo que calcula mult de dos complejos. Tal que el primer complejo sea la multiplicación de los dos
